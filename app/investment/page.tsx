    ...
    <>
      ...
      <section className="bg-cream py-24">
        <div className="max-w-[1320px] mx-auto px-8 md:px-12">
          <RevealWrapper>
            <div className="mb-14">
              <p className="text-[10px] font-semibold tracking-[0.25em] uppercase text-gold-700 mb-4">How I Help</p>
      ...
      <section className="bg-gold-500 py-20">
        <div className="max-w-[1320px] mx-auto px-8 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-ink-950/80 text-[14px] mt-2">Let&apos;s map out an investment strategy built around your goals.</p>
          </div>
